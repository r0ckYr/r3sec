    ...
    return (
        <div className="bg-black text-white">
            ...
            >
                ...
                >
                    <div className="bg-zinc-900 rounded-2xl p-8 md:p-12 border border-zinc-800 relative overflow-hidden">
                        <motion.div
                            className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-green-500 to-green-300"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center relative z-10">
                            ...
                            >
                                ...
                                <p className="text-zinc-400">Contracts Audited</p>
                            </motion.div>
                            ...
                            >
                                <motion.p
                                    ...
                                    viewport={{ once: true }}
                                >
                                    50<span className="text-green-400">+</span>
                                </motion.p>
                                <p className="text-zinc-400">Verified Auditors</p>
                            </motion.div>
                            ...
                            >
                                <motion.p
                                    ...
                                    viewport={{ once: true }}
                                >
                                    $1B<span className="text-green-400">+</span>
                                </motion.p>
                                <p className="text-zinc-400">Value Secured</p>
                            </motion.div>
                        </div>
                    </div>
                </motion.div>
